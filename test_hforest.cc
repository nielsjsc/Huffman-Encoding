...
void test_forest()
{
	...
	assert(forest.pop_bottom()->get_value() == 5);
	assert(forest.pop_bottom()->get_value() == 6);
	assert(forest.pop_bottom()->get_value() == 10);
	assert(forest.pop_bottom()->get_value() == 20);
	assert(forest.pop_bottom()->get_value() == 30);
	assert(forest.pop_bottom()->get_value() == 40);
	assert(forest.pop_bottom()->get_value() == 40);
	assert(forest.size() == 0);
	assert(forest.pop_bottom() == nullptr);
}
